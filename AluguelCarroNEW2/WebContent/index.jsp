...
<body>
	...
	<div class="allcontain">
		<div class="header">
			...
			<ul class="givusacall">
				<li>DA UMA CHAMADA : +66666666</li>
			</ul>
			<ul class="logreg">
				<li><a href="#">Login </a></li>
				<li><a href="#"><span class="registro">REGISTRO</span></a></li>
			</ul>
		</div>
		<!-- Navbar Up -->
			...
			<div class="container">
				<div class="navbar-header">
					<button type="button"
						...
						<span class="sr-only"> Ativa navegação</span> <span
				...
				<ul class="nav navbar-nav" id="navbarontop">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu dropdowncostume">
							...
							<li><a href="aluguel_carro_esportivo.jsp">Esportivo</a></li>
							<li><a href="3">3</a></li>
						</ul></li>
					<li><a href="contato.html">CONTATO</a></li>
					<button>
						<span class="postnewcar">PONHA NOVO CARRO</span>
					</button>
				</ul>
			</div>
		</nav>
					...
					<form class="navbar-form navbar-left searchformmargin"
						...
						<div class="form-group">
							<input type="text" class="form-control searchform"
								placeholder="Entre Palavra ">
						</div>
					</form>
					<ul class="nav navbar-nav navbarborder">
						<li class="li-categoria"><a
	...
	<div class="allcontain">
		<div class="feturedsection">
			<h1 class="text-center">
				<span class="bdots">&bullet;</span>A P R E S E N T A Ç Ã O<span
					class="carstxt">C A R R O S</span>&bullet;
			</h1>
		</div>
		...
		<div class="latestcars">
			<h1 class="text-center">&bullet; NOVIDADES DE CARROS &bullet;</h1>
			<ul class="nav nav-tabs navbar-left latest-navleft">
				<li role="presentation" class="li-sortby"><span class="sortby">DIVIDIDOS
						POR: </span></li>
				...
				<li role="presentation"><a href="#" class="alphSort">ALPHABETICO
				</a></li>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								...
								<div class="wishtxt">
									<p class="paragraph1">
										Adiciona para Lista de dejejo <span class="glyphicon glyphicon-heart"></span>
									</p>
									<p class="paragraph2">
		...
		<div class="newslettercontent">
			<div class="leftside">
				...
				<h1>NOTICIAS</h1>
				<p>
					Se escreve para o COLLECTIONCARS lista de emails para <br> receber
					atualisações sobre novas chegadas, orfetas especiais <br> e outros
				    descontos .
				</p>
			</div>
			<div class="rightside">
		...
		<div class="bottommenu">
			...
			<ul class="nav nav-tabs bottomlinks">
				...
				<li role="presentation"><a href="#/">ENCOMENDAS</a></li>
				<li role="presentation"><a href="#/">NOS CONTATE</a></li>
				<li role="presentation"><a href="#/">RECEBA NOSSA NOTICIAS</a></li>
			</ul>
			<p>
			...
			<div class="footer">
				<div class="copyright">
					&copy; Direito de copia 2016 | <a href="#">Privacidade </a>| <a href="#">Politica</a>
				</div>
				<div class="atisda">
					Desenvolvido por <a href="http://www.webdomus.net/">Web Domus Italia
						- Web Agency </a>
				</div>
			</div>
		</div>
